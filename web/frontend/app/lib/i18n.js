...
const STRINGS = {
  ko: {
    ...
    "tab.browse": "화학물질 검색",
    "tab.convert": "실시간 변환",
    "tab.ingredient": "성분 미리보기",
    "tab.catalog": "공공안전 카탈로그",

    "cat.title": "의약품 · 농약 · 산업재해를 점자로",
    "cat.desc": "국가 등록부 세 곳을 전량 점역했습니다. 아래에서 분야를 고르고 검색하세요. 화장품은 성분사전 이용약관상 재배포가 금지되어 카탈로그로 제공할 수 없으며, 「성분 미리보기」 탭에서 직접 입력해 확인하실 수 있습니다.",
    "cat.groupLabel": "분야",
    "cat.placeholder": "이름이나 본문으로 검색",
    "cat.count": "{n} {unit}",
    "cat.more": "더 보기",
    "cat.none": "결과가 없습니다.",
    "cat.pick": "왼쪽에서 항목을 고르세요.",
    "cat.loading": "불러오는 중…",
    "cat.failed": "불러오지 못했습니다.",
    "cat.unbuilt": "카탈로그가 아직 준비되지 않았습니다.",
    "cat.stats": "원문 {chars}자 · 점자 {cells}칸 · 글자당 {ratio}칸",
    "cat.copy": "점자 복사",
    "cat.copied": "점자를 복사했습니다.",
    "cat.txt": "TXT 내려받기",
    "cat.brf": "BRF 내려받기",

    "ing.title": "성분표를 구조로 바꿔 읽습니다",
    "ing.desc": "화장품 전성분표를 그대로 낭독하면 구조 없는 음절의 연속이 됩니다. 함량 순서로 나누고, 표시 대상 향료 성분을 짚고, 화학 어근을 분해하여 읽습니다. 아래 예시를 눌러 바로 확인해 보세요.",
    "ing.presetsLabel": "예시 목록",
    "ing.run": "요약 만들기",
    "ing.copy": "점자 복사",
    "ing.inputLabel": "성분표 입력 (쉼표로 구분)",
    "ing.placeholder": "정제수, 글리세린, 리날룰 …",
    "ing.summaryLabel": "음성용 요약",
    "ing.running": "읽는 중…",
    "ing.failed": "성분표를 읽지 못했습니다. 쉼표로 구분되어 있는지 확인해 주세요.",
    "ing.allergensTitle": "표시 대상 향료 성분",
    "ing.allergensNote": "유럽 화장품 규정이 라벨에 이름을 적도록 정한 성분입니다. 위험하다는 뜻이 아니라, 알레르기가 있는 사람이 확인할 수 있게 한 것입니다.",
    "ing.allergensNone": "표시 대상 향료 성분은 없습니다.",
    "ing.tableTitle": "성분별 구조",
    "ing.brailleTitle": "점자 · {n}칸",
    "ing.flag": "표시 대상",
    "ing.col.no": "순서",
    "ing.col.name": "성분명",
    "ing.col.band": "함량 대역",
    ...
    "ing.band.middle": "중간",
    "ing.band.trace": "미량",
    "ing.scope": "이 도구는 라벨에 적힌 것과 표시 규정이 지목한 것만 전달합니다. 성분의 안전성이나 피부 반응은 판단하지 않습니다.",
  ...
  en: {
    ...
    "tab.ingredient": "Ingredient preview",
    "tab.catalog": "Public-safety catalogues",

    "cat.title": "Medicines, pesticides and accident cases in braille",
    "cat.desc": "Three national registers, encoded in full. Pick a category below and search. Cosmetics are not here as a catalogue: the ingredient dictionary's terms of use prohibit redistribution, so the Ingredient preview tab takes a list you paste yourself.",
    "cat.groupLabel": "Category",
    "cat.placeholder": "Search names or text",
    "cat.count": "{n} {unit}",
    "cat.more": "Show more",
    "cat.none": "No results.",
    "cat.pick": "Choose an entry on the left.",
    "cat.loading": "Loading…",
    "cat.failed": "Could not load.",
    "cat.unbuilt": "The catalogue has not been built yet.",
    "cat.stats": "{chars} chars · {cells} cells · {ratio} cells per character",
    "cat.copy": "Copy braille",
    "cat.copied": "Braille copied.",
    "cat.txt": "Download TXT",
    "cat.brf": "Download BRF",

    "ing.title": "An ingredient list, read as structure",
    "ing.desc": "Read out verbatim, a cosmetics ingredient list is a run of syllables with no shape. This one is banded by concentration, has the labelled fragrance allergens pointed out, and has its chemical roots broken apart. Press an example to see it.",
    "ing.presetsLabel": "Worked examples",
    "ing.run": "Summarise",
    "ing.copy": "Copy braille",
    "ing.inputLabel": "Ingredient list (comma separated)",
    "ing.placeholder": "Water, Glycerin, Linalool …",
    "ing.summaryLabel": "Spoken summary",
    "ing.running": "Reading…",
    "ing.failed": "Could not read that as an ingredient list. Check that the names are comma separated.",
    "ing.allergensTitle": "Labelled fragrance allergens",
    "ing.allergensNote": "EU cosmetics rules require these to be named on the label. That does not mean they are dangerous; it means someone with an allergy can check.",
    "ing.allergensNone": "No labelled fragrance allergens.",
    "ing.tableTitle": "Ingredient by ingredient",
    "ing.brailleTitle": "Braille · {n} cells",
    "ing.flag": "declared",
    "ing.col.no": "No.",
    "ing.col.name": "Ingredient",
    "ing.col.band": "Concentration",
    "ing.col.roots": "Chemical roots",
    "ing.band.most": "most",
    "ing.band.high": "high",
    "ing.band.middle": "middle",
    "ing.band.trace": "trace",
    "ing.scope": "This tool reports what the label states and what labelling rules single out. It does not assess ingredient safety or predict skin reactions.",
