...
**Round-trip** — encode, decode, compare. This is the correctness check. A
mismatch means the encoder lost something, and the decoder is independent of it,
